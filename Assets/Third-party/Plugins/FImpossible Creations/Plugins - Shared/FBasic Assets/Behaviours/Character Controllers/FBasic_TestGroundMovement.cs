    ...
    public class FBasic_TestGroundMovement : MonoBehaviour
    {
        ...
        protected virtual void InitMovement()
        {
            ...
            if (animator)
            {
                ...
                if (animator.HasState(0, Animator.StringToHash("Jump"))) jumpAnimation = true;
            }
        ...
        protected virtual void HandleInput()
        {
                ...
                Input.GetKey(KeyCode.UpArrow) || Input.GetKey(KeyCode.LeftArrow) || Input.GetKey(KeyCode.DownArrow) || Input.GetKey(KeyCode.RightArrow))
            {
                ...
                if (Input.GetKey(KeyCode.D) || Input.GetKey(KeyCode.RightArrow)) RotationOffset = 90;
                if (Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.DownArrow)) RotationOffset = 180;
